...
st.markdown('<div class="one-header">🌿 AI Crop Monitoring System</div>', unsafe_allow_html=True)
...
if run_btn:
    ...
    st.info("Set your field inputs, upload images, and click the red button to run analysis.")